    ...
    try {
        ...
        `;
            ...
            $("#filter-form").submit(function(event) {
                ...
                if (lowPrice && highPrice) filteredData = Object.values(data).filter((product)=>product.productPrice >= lowPrice && product.productPrice <= highPrice);
                listProduct.empty();
                let filteredList = "";
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bUI0q","9XOu0"], "9XOu0", "parcelRequire0684")
