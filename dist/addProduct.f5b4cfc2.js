...
$(document).ready(function() {
    ...
    $("#save").on("click", ()=>{
        ...
        const product = new (0, _productDefault.default)(null, categoryIdCrlt.val(), productName, productImg, productPrice, productDesc);
        if (productName == "") {
            insertProduct.js;
            alert("Kh\xf4ng Được Để Trống");
        } else try {
...
},{"./constants/FirebaseConstants":"ar8Y5","./models/Category":"fOVWS","./models/Product":"b4We3","./services/CategoryService":"1bIMI","./services/ProductService":"63Op7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fOVWS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["frfQb","g5O8I"], "g5O8I", "parcelRequire0684")

//# sourceMappingURL=addProduct.f5b4cfc2.js.map
