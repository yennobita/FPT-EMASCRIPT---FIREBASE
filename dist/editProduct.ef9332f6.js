...
$(document).ready(function() {
    ...
    $("#update").on("click", ()=>{
        const products = new (0, _productDefault.default)(null, categoryIdCrlt.val(), productName.val(), productImg.val(), productPrice.val(), productDesc.val());
        console.log(products);
        if (productName == "" || productImg == "" || productPrice == "" || productDesc == "") alert("Kh\xf4ng Được Để Trống");
        else try {
...
},{"./constants/FirebaseConstants":"ar8Y5","./helpers/UrlHelper":"9C87C","./models/Product":"b4We3","./services/CategoryService":"1bIMI","./services/ProductService":"63Op7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9C87C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
parcelHelpers.defineInteropFlag(exports);
class Product {
    constructor(productId, categoryId, productName, productImg, productPrice, productDesc){
...
class CategoryService {
    ...
    findCategoryById = async (categoryId)=>{
        const res = await (0, _axiosDefault.default).get(`${this.realtimeDb}categories/${categoryId}.json`);
        return res.data;
    };
    // delete
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gvM1L","IO2EM"], "IO2EM", "parcelRequire0684")
