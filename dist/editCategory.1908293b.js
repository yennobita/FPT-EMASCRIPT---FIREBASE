...
$(document).ready(function() {
    ...
    $("#update").on("click", ()=>{
        const cate = new (0, _categoryDefault.default)(null, nameCrlt.val());
        if (nameCrlt == "") alert("Kh\xf4ng Được Để Trống");
        else try {
            categoryService.updateCategory(categoryIdCrlt.val(), cate).then((data)=>{
...
},{"./constants/FirebaseConstants":"ar8Y5","./helpers/UrlHelper":"9C87C","./models/Category":"fOVWS","./services/CategoryService":"1bIMI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9C87C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fOVWS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Category {
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hoOPg","lnEw9"], "lnEw9", "parcelRequire0684")
